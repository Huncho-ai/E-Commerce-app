...
import '../ItemPages/itemPage.dart';
        ...
        Container(
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>ItemPage(image: 'assets/fashion/$i.jpg', ProductTitle: 'Product Name', Total: price[i],)));
                  },
                  child: Container(
                    margin: const EdgeInsets.all(10),
                    child: Image.asset(
                      'assets/fashion/$i.jpg',
                      height: 120,
                      width: 120,
                    ),
                  ),
